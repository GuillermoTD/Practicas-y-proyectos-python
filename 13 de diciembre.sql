...
------------------UPDATES-------------------
CREATE PROCEDURE Guillermo.SP_UPDATE_CLIENTE
	@ID_Cliente INT,
	@Nombre NVARCHAR(50),
	@Direccion NVARCHAR(50),
	@Telefono char(15),
...
CREATE PROCEDURE Guillermo.SP_UPDATE_EMPLEADO
	@ID_Cliente INT,
	@Nombre NVARCHAR(50),
	@Direccion NVARCHAR(50),
	@Telefono char(15),
...
CREATE PROCEDURE Guillermo.SP_UPDATE_PUESTO
		@ID_Puesto INT,
		@Descripcion NVARCHAR

AS 
BEGIN
	UPDATE Guillermo.Puesto
	SET Descripcion = @Descripcion
		WHERE ID_Puesto = @ID_Puesto
END


CREATE PROCEDURE Guillermo.SP_UPDATE_INVENTARIO
		@ID_Producto INT,
		@ID_Sucursal INT,
		@Cantidad NVARCHAR,
		@ID_Inventario NVARCHAR

AS 
BEGIN
	UPDATE Guillermo.Inventario
	SET Cantidad = @Cantidad, ID_Sucursal = @ID_Sucursal
...
EXECUTE Guillermo.SP_INSERT_Cliente

select * from Guillermo.Empleado
